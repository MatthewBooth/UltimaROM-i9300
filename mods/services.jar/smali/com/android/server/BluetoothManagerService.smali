...
.method static synthetic access$1500(Lcom/android/server/BluetoothManagerService;)Landroid/app/AlertDialog;
    .locals 1
...
.method static synthetic access$1600(Lcom/android/server/BluetoothManagerService;)I
    .locals 1
...
.method static synthetic access$1602(Lcom/android/server/BluetoothManagerService;I)I
    .locals 0
...
.method static synthetic access$3100(Lcom/android/server/BluetoothManagerService;Z)V
    .locals 0
...
.method static synthetic access$4102(Lcom/android/server/BluetoothManagerService;Z)Z
    .locals 0
...
.method public enable()Z
    ...
    const-string v10, "enable(): not allowed for non-active and non system user"
    ...
    invoke-virtual {v7, v10}, Landroid/app/admin/DevicePolicyManager;->getAllowBluetoothMode(Landroid/content/ComponentName;)I
    ...
    const-string v10, "Exchange IT Policy has disabled Bluetooth. Cannot enable"
    ...
    iget-object v9, p0, Lcom/android/server/BluetoothManagerService;->mHandler:Lcom/android/server/BluetoothManagerService$BluetoothHandler;
    ...
    const-string v11, "Oops: enable BT dev_btlock_state "
    ...
    invoke-virtual {v8, v0, v10, v11}, Landroid/os/Handler;->sendMessageDelayed(Landroid/os/Message;J)Z
    ...
    :cond_3
    sput-boolean v8, Lcom/android/server/BluetoothManagerService;->isEnablePopup:Z
    ...
    const-string v11, "enable():  mBluetooth ="

    invoke-virtual {v10, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v11, p0, Lcom/android/server/BluetoothManagerService;->mBluetooth:Landroid/bluetooth/IBluetooth;
    ...
    iget-boolean v11, p0, Lcom/android/server/BluetoothManagerService;->mBinding:Z
    ...
    :cond_5
    iget-object v10, p0, Lcom/android/server/BluetoothManagerService;->mReceiver:Landroid/content/BroadcastReceiver;
    ...
    :try_start_0
    iput-boolean v8, p0, Lcom/android/server/BluetoothManagerService;->mQuietEnableExternal:Z
    ...
    invoke-direct {p0, v8}, Lcom/android/server/BluetoothManagerService;->persistBluetoothSetting(I)V

    invoke-static {v2, v3}, Landroid/os/Binder;->restoreCallingIdentity(J)V

    const/4 v8, 0x0

    invoke-direct {p0, v8}, Lcom/android/server/BluetoothManagerService;->sendEnableMsg(Z)V
