...
.method public varargs execute(ILjava/lang/String;[Ljava/lang/Object;)[Lcom/android/server/NativeDaemonEvent;
    ...
    iget-object v15, v0, Lcom/android/server/NativeDaemonConnector;->mSequenceNumber:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    new-instance v15, Lcom/android/server/NativeDaemonConnectorException;

    const-string v17, "missing output stream"

    move-object/from16 v0, v17

    invoke-direct {v15, v0}, Lcom/android/server/NativeDaemonConnectorException;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v7, v15}, Ljava/lang/StringBuilder;->setCharAt(IC)V
    ...
    invoke-direct {v15, v0, v2}, Lcom/android/server/NativeDaemonConnectorException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v15, v12, v0, v9}, Lcom/android/server/NativeDaemonConnector$ResponseQueue;->remove(IILjava/lang/String;)Lcom/android/server/NativeDaemonEvent;
    ...
    new-instance v15, Lcom/android/server/NativeDaemonConnector$NativeDaemonFailureException;

    invoke-direct {v15, v9, v5}, Lcom/android/server/NativeDaemonConnector$NativeDaemonFailureException;-><init>(Ljava/lang/String;Lcom/android/server/NativeDaemonEvent;)V
    ...
    new-instance v15, Lcom/android/server/NativeDaemonConnector$NativeDaemonArgumentException;

    invoke-direct {v15, v9, v5}, Lcom/android/server/NativeDaemonConnector$NativeDaemonArgumentException;-><init>(Ljava/lang/String;Lcom/android/server/NativeDaemonEvent;)V
    ...
    invoke-virtual {v8, v7, v15}, Ljava/lang/StringBuilder;->setCharAt(IC)V
    ...
    new-array v15, v15, [Lcom/android/server/NativeDaemonEvent;

    invoke-virtual {v6, v15}, Ljava/util/ArrayList;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object v15

    check-cast v15, [Lcom/android/server/NativeDaemonEvent;
