...
.method private notifySwitch(JII)V
    ...
    invoke-interface {v5, p1, p2, v4}, Lcom/android/server/input/InputManagerService$WindowManagerCallbacks;->notifyWirelessChargingChanged(JZ)V
...
.method public updatePenHoveringFromSettings()V
    ...
    invoke-direct {p0, v2}, Lcom/android/server/input/InputManagerService;->getPenHoveringSetting(Z)Z
    ...
    :goto_0
    invoke-static {v3, v1}, Lcom/android/server/input/InputManagerService;->nativeSetPenHovering(IZ)V

    if-nez v0, :cond_1

    iget v1, p0, Lcom/android/server/input/InputManagerService;->mPtr:I

    invoke-static {v1, v2}, Lcom/android/server/input/InputManagerService;->nativeSetShowHovering(IZ)V
