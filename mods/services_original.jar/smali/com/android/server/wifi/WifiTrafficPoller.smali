...
.method constructor <init>(Landroid/content/Context;Lcom/android/server/wifi/WifiService;Ljava/lang/String;)V
    ...
    iput-boolean v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mNeedBooster:Z

    iput v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mHotspotClientNum:I
    ...
    iput-object v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mThresholdKbytes:[J

    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    iput-object v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mClients:Ljava/util/List;
    ...
    iput-object v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mScreenOn:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-array v3, v6, [I

    fill-array-data v3, :array_1

    iput-object v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCpuFreqindex:[I

    iput-object p3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mInterface:Ljava/lang/String;

    new-instance v3, Lcom/android/server/wifi/WifiTrafficPoller$TrafficHandler;

    invoke-direct {v3, p0, v5}, Lcom/android/server/wifi/WifiTrafficPoller$TrafficHandler;-><init>(Lcom/android/server/wifi/WifiTrafficPoller;Lcom/android/server/wifi/WifiTrafficPoller$1;)V

    iput-object v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mTrafficHandler:Lcom/android/server/wifi/WifiTrafficPoller$TrafficHandler;
    ...
    new-instance v3, Lcom/android/server/wifi/WifiTrafficPoller$1;

    invoke-direct {v3, p0}, Lcom/android/server/wifi/WifiTrafficPoller$1;-><init>(Lcom/android/server/wifi/WifiTrafficPoller;)V
    ...
    iget-object v3, p0, Lcom/android/server/wifi/WifiTrafficPoller;->mCpuBooster:Landroid/os/DVFSHelper;
    ...
    sget-object v4, Lcom/android/server/wifi/WifiTrafficPoller;->mCurrentMode:Lcom/android/server/wifi/WifiTrafficPoller$BoosterMode;
    ...
    sget-boolean v3, Lcom/android/server/wifi/WifiTrafficPoller;->DBG:Z
    ...
    const-string/jumbo v5, "supportedCPUFreqTable : "
...
.method public notifyOnDataActivity()V
    ...
    iget-wide v13, v0, Lcom/android/server/wifi/WifiTrafficPoller;->mTxPkts:J

    move-object/from16 v0, p0

    iget-wide v9, v0, Lcom/android/server/wifi/WifiTrafficPoller;->mRxPkts:J
    ...
    iget-wide v11, v0, Lcom/android/server/wifi/WifiTrafficPoller;->mTxBytes:J

    move-object/from16 v0, p0

    iget-wide v7, v0, Lcom/android/server/wifi/WifiTrafficPoller;->mRxBytes:J
    ...
    sget-object v22, Lcom/android/server/wifi/WifiTrafficPoller;->mCurrentMode:Lcom/android/server/wifi/WifiTrafficPoller$BoosterMode;
